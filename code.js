allWords = {
    names: ['Հովհաննես Թումանյան', 'Գևորգ Էմին', 'Ակսել Բակունց', 'Վահան Տերյան', 'Նաիրի Զարյան', 'Րաֆֆի', 'Պերճ Պռոշյան', 'Սահակ Պարթև',
        ...
        'Արկադի Տեր Թադևոսյան', 'Աղաս Մանուկայն', 'Ջեֆ Բեզոս', 'Ալեքսանդր Սպենդարյան', 'Ուսեին Բոլտ', 'Ռաֆաել Նադալ', 'Էնրիկե Իգլեսիաս',
        'Գրիգոր Կոկչյան', 'Ռիչարդ Մադլենյան', 'Անահիտ Կիրակոսյան', 'Գրիգորի Լեպս', 'Գագիկ Շամշյան', 'Իլան Մասկ', 'Վաչե Ամարյան', 'Թաթա Սիմոնյան',
        'Սոֆի Մխեյան', 'Գառ Վարդանյան', 'Բռեթ Փիթ', 'Թոմ Կռուզ', 'Դավիթ Գրեգ', 'Ջիմ Քերրի', 'Ուիլ Սմիթ', 'Թոմ Հոլլանդ', 'Մարտին Յորգանց', 'Քվենտին Տարանտինո',
        'Կարեն Ջանիբեկյան', 'Մադոննա', 'Ռուդոլֆ Ղևոնդյան', 'Ջոննի Դեփ', 'Դենիել Ռեդքլիֆ', 'Ադել', 'Աշոտ Ղազարյան', 'Սալվադոր Դալի', 'Նատալի Պոտման',
        'Ռուբեն Հախվերդյան', 'Ուիլյամ Շեքսպիր', 'Սոս Սարգսյան', 'Մակոլեյ Կալկին'],
    items: ['աթոռ', 'սեղան', 'պահարան', 'ծաղկաման', 'բազկաթոռ', 'բազմոց', 'մահճակալ', 'լուսամփոփ', 'աստիճան', 'գիրք', 'տետր', 'մատիտ',
        ...
        'զեփյուռ', 'անզոր', 'երկյուղել', 'փուչ', 'հանճար', 'գիտնական', 'գանձարան', 'մեծացնել', 'ճյուղ', 'սոսնձել', 'ստորադաս', 'սահնակ', 'ենթակա',
        ...
        'մարսել', 'մանկաբույժ', 'ետնաբեմ', 'սպանախ', 'թավջութակ', 'թավջութակահար', 'քաղաքակիրթ', 'քաղաքակրթություն', 'միջնորդել', 'անուշադիր', 'բջիջ',
    ...
    company: ['Google', 'Yandex', 'Facebook', 'Instagram', 'Opera', 'Apple', 'Samsung', 'Xiaomi', 'Lenovo', 'Huawei', 'Hisense', 'Adidas', 'Nike', 'Puma', 'Amazon', 'Microsoft',
        ...
        'Louis Vuitton', 'Fila', 'Lacoste', 'Prada', 'Gucci', 'NASA', 'Playstation', 'Nescafe', 'Skype', 'Red Bull', 'Toshiba', 'Dell', 'Philips    ']
}
...
document.querySelector('.start-btn').addEventListener('click', () => {
    if (+document.querySelector('.time').value && +document.querySelector('.players').value &&
        ...
        if (document.querySelector('#topic').value !== 'all') words = allWords[document.querySelector('#topic').value]
        else {
            for (let key in allWords) {
                words = [...words, ...allWords[key]]
            }
        }
        randomUnknownsCount()
