words = ['Հովհաննես Թումանյան', 'Գևորգ Էմին', 'Ակսել Բակունց', 'Վահան Տերյան', 'Նաիրի Զարյան', 'Րաֆֆի', 'Պերճ Պռոշյան', 'Սահակ Պարթև',
    ...
    'անկոտրում', 'լիմուզին', 'ոհմակ', 'հետևյալ', 'սիզամարգ', 'հուշարձան', 'շատակեր', 'նորաձևություն', 'հիմար', 'ռեֆլեքս', 'ագրեսիա', 'եռապատիկ', 'Ռեալ Մադրիդ', 'Բարսելոնա', 'Ատլետիկո Մադրիդ', 'Վալենսիա', 'Վիլիառեալ', 'Սեվիլիա', 'Էլչե', 'Խետաֆե', 'Ատլետիկ Բ', 'Լեվանտե',
    ...
    'Սեսկ Ֆաբռեգաս', 'Վիսամ բԵՆ Յեդդեռ', 'Շտուդգարտ', 'Հայաստան', 'Վրաստան', 'Երևան', 'Նորավանք', 'Թբիլիսի', 'Իջևան', 'Վայոց ձոր', 'Սյունիք', 'Արմավիր', 'Արարատ', 'Արմավիր', 'Արտաշատ', 'Կոտայք',
...
document.querySelector('.start-btn').addEventListener('click', () => {
    if (+document.querySelector('.time').value && +document.querySelector('.players').value &&
        +document.querySelector('.unknowns').value && +document.querySelector('.players').value > +document.querySelector('.unknowns').value) {
